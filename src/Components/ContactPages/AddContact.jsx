...
class AddContact extends React.Component{
    ...
    handleAddContactFormSubmit = (e) =>{
        ...
        if(response.status === "success"){
            this.setState({
                errorMessage: undefined, successMessage : response.msg
            })
            document.querySelector(".contact-form").reset();
        }else{
            this.setState({
                errorMessage: response.msg, successMessage : undefined
            })
        }
    }
    ...
    return(
        <div className="border col-12 text-white p-2">
            ...
            <input hidden name="contactId" defaultValue={this.props.isUpdating? this.props.selectedContact.id : ""} />
                <div className="row p-2">            
                    <div className="col-12 text-white-50">{this.props.isUpdating? "Updated Contact" :"Add a new Contact"}</div>
                    ...
                    <div className={`col-12 p-1 
                            ${
                                this.props.isUpdating ? "col-md-4 offset-md-2" : "col-md-6 offset-md-3"
                            }`}>
                    ...
                    <div className="col-12 col-md-4 p-1">
                        {this.props.isUpdating && (
                            <button className="btn btn-secondary form-control btn-sm" onClick={this.cancelContact}>
                                Cancel
                            </button>
                        )}
                    </div>
